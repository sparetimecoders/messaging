...
# NATS -- subprocess mode (builds and spawns nats-adapter binary)
...
# AMQP -- subprocess mode (builds and spawns amqp-adapter binary)
cd golang && \
  RABBITMQ_URL=amqp://guest:guest@localhost:5672/ \
  go test -race -count=1 -run TestIntegrationTCKSubprocess -v ./amqp/...
